...
-record(challenge, {
	  ...
	  formulae :: list(binary())% a list of formula ids for which the user should provide latex source code eg [f0040123456789abcdefeeeeeeeeeeee]
	 }).
...
-record(response, {
	  ...
	  formulae :: list(binary()), % a list of formula ids for which the user provided latex source code eg [f0040123456789abcdefeeeeeeeeeeee]
